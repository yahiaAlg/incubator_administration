# Generated by Django 5.1.5 on 2025-02-18 21:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='files', to='accounts.material')),
            ],
        ),
        migrations.CreateModel(
            name='MaterialImage',
            fields=[
                ...
                ('material', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='accounts.material')),
            ],
        ),
        migrations.CreateModel(
            name='Phase',
            fields=[
                ...
                ('deadline', models.DateField()),
                ('plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='phases', to='accounts.plan')),
            ],
            options={
                'verbose_name': 'phase',
        ...
        migrations.AddField(
            model_name='plan',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='plans', to='accounts.project'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('phase', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='accounts.phase')),
            ],
            options={
                'verbose_name': 'task',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('task', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='events', to='accounts.task')),
            ],
            options={
                'verbose_name': 'Event',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(default=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.department')),
                ('faculty', models.ForeignKey(default=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.faculty')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.project')),
                ('speciality', models.ForeignKey(default=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.speciality')),
                ('user', models.OneToOneField(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='team_member', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
